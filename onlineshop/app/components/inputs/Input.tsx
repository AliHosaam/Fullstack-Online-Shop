...
const Input: React.FC<InputProps> = ({
  ...
  return (
    <div className="w-full relative">
      ...
      />
      <label
        className={`absolute cursor-text text-md duration-150 -translate-y-4 top-5 origin-[0] left-5 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4  ${
